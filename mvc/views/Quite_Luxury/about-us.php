            ...
            <div class="row">
              <div class="col-md-8">
                <div class="section-title">
                  <h4 class="text-uppercase">Hotel Quite Luxury. since 2000</h4>
                  <p class="section-subtitle">High quality accommodation services</p>
                </div>
                <div class="info-branding">
                  <p>Hello. Our hotel has been around for over 20 years. We do what's best for all of our customers.</p>
                  <p>Located in the beautiful Mui Ne Bay and overlooking the pristine Hon Lao in the middle of the blue sea, Quite Luxury includes 105 5-star rooms equipped with modern and luxurious furniture, 2 restaurants, a real swimming pool. The largest and most unique Bugalow series is the stylized design of the mysterious Cham tower architecture.</p>
                  <div class="providers">
              ...
              <div class="col-md-4">
                <div class="brand-info">
                  <div class="inner">
                    <div class="content">
                      <img src="images/quiteluxury_logo.png" width="100%" alt="Hotel Himara">
                      <div class="stars">
                      ...
                      <p class="mt20">Quite Luxury Hotel is a 5-star world-class hotel. Always attach great importance to comfort and comfort.</p>
                    </div>
                  </div>
                </div>
              </div>
