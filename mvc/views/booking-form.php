...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./mvc/Assets/css/bootstrap-select.min.css">
    <link rel="stylesheet" href="./mvc/Assets/css/jquery.mmenu.css">
    <link rel="stylesheet" href="./mvc/Assets/revolution/css/layers.css">
    <link rel="stylesheet" href="./mvc/Assets/revolution/css/settings.css">
    <link rel="stylesheet" href="./mvc/Assets/revolution/css/navigation.css">
    <link rel="stylesheet" href="./mvc/Assets/css/animate.min.css">
    <link rel="stylesheet" href="./mvc/Assets/css/owl.carousel.min.css">
    <link rel="stylesheet" href="./mvc/Assets/css/daterangepicker.css">
  ...
  <body>
          ...
          <div class="top-right-menu">
            <ul class="top-menu">
              ...
              <li class="language-menu">
                <a href="#" class="active-language"><img src="./mvc/Assets/images/icons/flags/gb.png" alt="Image">English</a>
                <ul class="languages">
                  <li class="language">
                    <a href="#"><img src="./mvc/Assets/images/icons/flags/it.png" alt="Image">Italiano</a>
                  </li>
                  <li class="language">
                    <a href="#"><img src="./mvc/Assets/images/icons/flags/gr.png" alt="Image">Ελληνικα</a>
                  </li>
                  <li class="language">
                    <a href="#"><img src="./mvc/Assets/images/icons/flags/al.png" alt="Image">Shqip</a>
                  </li>
                  <li class="language">
                    <a href="#"><img src="./mvc/Assets/images/icons/flags/fr.png" alt="Image">Français</a>
                  </li>
                  <li class="language">
                    <a href="#"><img src="./mvc/Assets/images/icons/flags/es.png" alt="Image">Español</a>
                  </li>
                </ul>
              </li>
            </ul>
      ...
      <header class="horizontal-header sticky-header" data-menutoggle="991">
        <div class="container">
          ...
          <div class="brand">
            <div class="logo">
              <a href="index.html">
                <img src="./mvc/Assets/images/logo.svg" alt="Hotel Himara">
              </a>
            </div>
          </div>
          <!-- MOBILE MENU BUTTON -->
            ...
            <ul class="menu">
              ...
              <li class="menu-item dropdown">
                ...
                <ul class="submenu">
                  ...
                  <li class="menu-item">
                    <a href="./mvc/Assets/restaurant.html">Our Restaurant</a>
                  </li>
                  <li class="menu-item">
                ...
                <div class="contact-details">
                  ...
                  <div class="offer-item sm mb50">
                    <figure class="gradient-overlay-hover link-icon">
                      <a href="offer.html">
                        <img src="./mvc/Assets/images/offers/offer1.jpg" class="img-fluid" alt="Image">
                      </a>
                    </figure>
                    <div class="ribbon">
                  ...
                  <div class="offer-item sm mb50">
                    <figure class="gradient-overlay-hover link">
                      <a href="offer.html">
                        <img src="./mvc/Assets/images/offers/offer2.jpg" class="img-fluid" alt="Image">
                      </a>
                    </figure>
                    <div class="ribbon">
                      <span>HOT OFFER</span></div>
                  ...
                  <div class="offer-item sm mb50">
                    <figure class="gradient-overlay-hover link">
                      <a href="offer.html">
                        <img src="./mvc/Assets/images/offers/offer3.jpg" class="img-fluid" alt="Image">
                      </a>
                    </figure>
                    <div class="ribbon">
                      <span>HOT OFFER</span></div>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="footer-widget">
                  <img src="./mvc/Assets/images/logo.svg" class="footer-logo" alt="Hotel Himara">
                  <div class="inner">
                    ...
                    <a href="https://www.tripadvisor.com/" target="_blank">
                      <div class="tripadvisor-banner">
                        ...
                        <img src="./mvc/Assets/images/icons/tripadvisor.png" alt="Image">
                      </div>
                    </a>
                  </div>
                </div>
    ...
    <script src="./mvc/Assets/http://maps.google.com/maps/api/js?key=YOUR_API_KEY"></script>
    <script src="./mvc/Assets/js/bootstrap.min.js"></script>
    <script src="./mvc/Assets/js/bootstrap-select.min.js"></script>
    <script src="./mvc/Assets/js/jquery.mmenu.js"></script>
    <script src="./mvc/Assets/js/jquery.inview.min.js"></script>
    <script src="./mvc/Assets/js/jquery.countdown.min.js"></script>
    <script src="./mvc/Assets/js/jquery.magnific-popup.min.js"></script>
    <script src="./mvc/Assets/js/owl.carousel.min.js"></script>
    <script src="./mvc/Assets/js/owl.carousel.thumbs.min.js"></script>
    <script src="./mvc/Assets/js/isotope.pkgd.min.js"></script>
    <script src="./mvc/Assets/js/imagesloaded.pkgd.min.js"></script>
    <script src="./mvc/Assets/js/masonry.pkgd.min.js"></script>
    <script src="./mvc/Assets/js/wow.min.js"></script>
    <script src="./mvc/Assets/js/countup.min.js"></script>
    <script src="./mvc/Assets/js/moment.min.js"></script>
    <script src="./mvc/Assets/js/daterangepicker.js"></script>
    <script src="./mvc/Assets/js/parallax.min.js"></script>
    <script src="./mvc/Assets/js/smoothscroll.min.js"></script>
    <script src="./mvc/Assets/js/instafeed.min.js"></script>
    <script src="./mvc/Assets/js/main.js"></script>
    <!-- ========== REVOLUTION SLIDER ========== -->
    <script src="./mvc/Assets/revolution/js/jquery.themepunch.tools.min.js"></script>
    <script src="./mvc/Assets/revolution/js/jquery.themepunch.revolution.min.js"></script>
    <script src="./mvc/Assets/revolution/js/extensions/revolution.extension.actions.min.js"></script>
    <script src="./mvc/Assets/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
    <script src="./mvc/Assets/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
    <script src="./mvc/Assets/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
    <script src="./mvc/Assets/revolution/js/extensions/revolution.extension.migration.min.js"></script>
    <script src="./mvc/Assets/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
    <script src="./mvc/Assets/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
    <script src="./mvc/Assets/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
    <script src="./mvc/Assets/revolution/js/extensions/revolution.extension.video.min.js"></script>
  </body>
</html>