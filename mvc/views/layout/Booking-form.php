              ...
              <form  method="POST" class="booking-form-advanced" >
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Country</label>
                      <select name="booking-country" class="form-control" value="Australia" title="Select Your Country" data-header="Select Your Country" data-live-search="true" data-size="5">
