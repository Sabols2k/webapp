...
<head>
    ...
    <!-- ========== FAVICON ========== -->
    <link rel="icon" href="<?php echo URL ."mvc/Assets/layout/images/favicon-logo.png"?>">
  </head>
  <body>
    <!-- ========== MOBILE MENU ========== -->
      ...
      <div class="blog-post-cover gradient-overlay op5" data-src="images/blog/post/blog-full.jpg" data-parallax="scroll" data-speed="0.3" data-mirror-selector=".wrapper" data-z-index="0">
        <div class="container inner">
          ...
          <div class="blog-post-info">
            <img alt="" src="images/blog/users/user1.jpg" class="avatar avatar-234 photo" height="234" width="234">
            <p>by
              <span>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-9 col-12">
              <article class="entry">
                <div class="details">
                  <p class="dropcap">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis
                ...
                <ul id="comments-list" class="comments-list">
                  <li>
                    ...
                    <ul class="comments-list reply-list">
                      <li>
                        <div class="comment-avatar"><img src="images/blog/users/user2.jpg" alt=""></div>
                        <div class="comment-box">
                          <div class="comment_content">
                            <h4 class="author-name">
                              <a href="#">
