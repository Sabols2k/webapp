...
(function (a, b) {
  ...
  (function (g) {
    ...
    g.expr.pseudos.aicontains = function (q, n, p) {
      var r = g(q).find("span.dropdown-item-inner");
      var o = (r.data("tokens") || r.data("normalizedText") || r.text())
        .toString()
        .toUpperCase();
      return o.includes(p[3].toUpperCase());
    };
    ...
    k.prototype = {
      ...
      createDropdown: function () {
        var s = this.multiple || this.options.showTick ? " show-tick" : "",
          o = this.$element.parent().hasClass("input-group")
            ? " input-group-btn"
            : "",
      ...
      createLi: function () {
        ...
        var p = function (B, z, A, y) {
          ...
          return (
            ...
            (typeof z !== "undefined" && null !== z
              ? ' data-original-index="' + z + '"'
              : "") +
            (typeof y !== "undefined" && null !== y
              ? 'data-optgroup="' + y + '"'
              : "") +
            ">" +
            B +
          ...
          if (z && B.data("divider") !== true) {
            if (u.options.hideDisabled && G) {
              if (J.data("allOptionsDisabled") === undefined) {
                ...
                J.data(
                  "allOptionsDisabled",
                  N.filter(":disabled").length === N.length
                );
              }
      ...
      render: function (r) {
        ...
        if (
          ...
          if (
            (s.length > 1 && p.length > s[1]) ||
            (s.length == 1 && p.length >= 2)
          ) {
            n = this.options.hideDisabled ? ", [disabled]" : "";
            var u = o.not('[data-divider="true"], [data-hidden="true"]' + n)
                .length,
              v =
      ...
      setSize: function () {
        ...
        if (this.options.size === "auto") {
          ...
          D.off("resize.getSize scroll.getSize").on(
        ...
        this.$element.on("shown.bs.select", function () {
          if (!n.options.liveSearch && !n.multiple) {
            ...
            if (!n.multiple) {
              ...
              q =
                q - n.$menuInner[0].offsetHeight / 2 + n.sizeInfo.liHeight / 2;
        ...
        this.$searchbox.on("input propertychange", function () {
          ...
          if (o.$searchbox.val()) {
            ...
            if (o.options.liveSearchNormalize) {
              p = q.not(
                ":a" + o._searchStyle() + '("' + c(o.$searchbox.val()) + '")'
              );
            } else {
              p = q.not(
                ":" + o._searchStyle() + '("' + o.$searchbox.val() + '")'
              );
            }
            if (p.length === q.length) {
              n.html(
                o.options.noneResultsText.replace(
                  "{0}",
                  '"' + l(o.$searchbox.val()) + '"'
                )
              );
      ...
      keydown: function (x) {
        ...
        if (
          (/(^9$|27)/.test(x.keyCode.toString(10)) &&
            z &&
            (u.multiple || u.options.liveSearch)) ||
        ...
        if (w.is("select")) {
          ...
          if (!v) {
            ...
            s.template = g.extend(
              ...
              k.DEFAULTS.template,
              g.fn.selectpicker.defaults
                ? g.fn.selectpicker.defaults.template
                : {},
              w.data().template,
              t.template
            );
